...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-10">
      <nav className="flex flex-col items-center md:flex-row md:px-8 lg:px-16 md:justify-between p-5 gap-4 text-white bg-customGreen2">
        ...
        <ul className="flex justify-between w-full md:max-w-[50%]">
          <li className="relative overflow-hidden group capitalize text-[18px] lg:text-[20px] cursor-pointer">
            ...
            <span
              linkId={1}
              className="absolute bottom-[100%] left-0 group-hover:bottom-0 transition-75 navLinks"
            >
              Home
            </span>
      ...
      <div
        className="select-none font-NotoSansJapanses text-customGreen2 w-full overflow-hidden tracking-[6px] mt-[-11px] text-[17px] translate-x-[-6px] navBinaryAnime"
      ...
      <div
        className="select-none font-NotoSansJapanses text-customGreen2 w-full overflow-hidden tracking-[4px] mt-[-15px] translate-x-[-3px] opacity-80 navBinaryAnime"
      ...
      <div
        className="select-none font-NotoSansJapanses text-customGreen1 w-full overflow-hidden tracking-[10px] mt-[-30px] translate-x-[-4px] opacity-70 text-[18px] navBinaryAnime"
      ...
      <div
        className="select-none font-NotoSansJapanses text-customGreen2 w-full overflow-hidden tracking-[3px] mt-[-15px] translate-x-[-10px] opacity-60 navBinaryAnime"
      ...
      <div
        className="select-none font-NotoSansJapanses text-customGreen3 w-full overflow-hidden tracking-[13px] mt-[-30px] translate-x-[-6px] opacity-80 text-[18px] navBinaryAnime"
