  ...
  return (
    <header className="">
      <nav className="flex flex-col items-center md:flex-row md:px-8 lg:px-16 md:justify-between p-5 gap-4 text-white bg-gradient-to-b from-customGreen3 to-[#3f8d2e]">
        <div className="capitalize md:text-2xl lg:text-3xl font-mono">
      ...
      <div className="text-[#3f8d2e] w-full overflow-hidden tracking-[6px] mt-[-11px] text-[17px] translate-x-[-6px] navBinaryAnime" style={{animationDelay: ".2s"}}>
      ...
      <div className="text-customGreen2 w-full overflow-hidden tracking-[4px] mt-[-15px] translate-x-[-3px] opacity-80 navBinaryAnime" style={{animationDelay: ".5s"}}>
      ...
      <div className="text-customGreen1 w-full overflow-hidden tracking-[10px] mt-[-30px] translate-x-[-4px] opacity-70 text-[18px] navBinaryAnime" style={{animationDelay: ".8s"}}>
      ...
      <div className="text-customGreen2 w-full overflow-hidden tracking-[3px] mt-[-15px] translate-x-[-10px] opacity-60 navBinaryAnime" style={{animationDelay: ".3s"}}>
      ...
      <div className="text-customGreen3 w-full overflow-hidden tracking-[13px] mt-[-30px] translate-x-[-6px] opacity-80 text-[18px] navBinaryAnime" style={{animationDelay: "0"}}>
