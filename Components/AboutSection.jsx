  ...
  return (
    ...
    >
      ...
      <div className="scrollNeededContainer w-[80%] max-w-[800px] h-[70%] overflow-y-scroll z-10 bg-customGreen4/40 mt-16 p-5 flex flex-wrap justify-center about--contentContainer">
        <h2 className={`opacity-0 text-white capitalize text-[23px] md:text-[30px] lg:text-[35px] text-center mb-3 ${header.length === 0 && "font-flowCircular"} about--header`}>
          {(header.length === 0) ? "hello i am someone nice to meet you" : header}
        </h2>
        <div className="flex flex-col md:flex-row justify-between p-3">
          <p className={`opacity-0 text-white capitalize text-justify text-[12px] md:text-[15px] lg:text-[16px] md:w-[45%] w-full ${header.length === 0 && "font-flowCircular"} select-none about--pragOne`}>
            ...
            Doloribus sint ipsam alwias pariatur nobis ut tempora quos placeat
