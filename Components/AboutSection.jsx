...
const AboutSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-[80%] max-w-[800px] z-10 bg-customGreen4/40 mt-16 rounded-[30px] p-5 flex flex-wrap justify-center">
        <h2 className="text-white capitalize text-[23px] lg:text-[30px] text-center mb-3">hello i am omid nice to meet you</h2>
        <div className="flex flex-col md:flex-row justify-between p-3">
          <p className="text-white/70 capitalize text-justify text-[12px] md:text-[15px] lg:text-[16px] md:w-[45%] w-full">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Debitis placeat animi ullam voluptate porro quidem sit dolorem aspernatur quis perspiciatis laboriosam sed mollitia ea dignissimos, optio deleniti? Cupiditate, laboriosam quia.
